...
const allCourses = [
  {
    ...
    staff_ids: [academicHayden.id, academicJake.id],
    member_ids: [academicHayden.id, academicJake.id, academicTam.id, academicGiuliana.id, academicRani.id],
  },
  {
    id: 2511,
    name: 'COMP2511',
    description: 'Object-Oriented Design & Programming',
    staff_ids: [academicHayden.id],
    member_ids: [academicHayden.id, academicTam.id, academicGiuliana.id, academicRani.id],
  },
  {
    id: 6080,
    name: 'COMP6080',
    description: 'Web Front-End Programming',
    staff_ids: [academicGiuliana.id],
    member_ids: [academicGiuliana.id, academicTam.id, academicRani.id],
  },
];
const [course2041, course2511, course6080] = allCourses;

// FIXME:
// Will probably switch to this when I get the chance;
